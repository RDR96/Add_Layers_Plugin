...
SOURCES = \
	__init__.py \
	add_layers.py add_layers_dialog.py

PLUGINNAME = add_layers

PY_FILES = \
	__init__.py \
	add_layers.py add_layers_dialog.py

UI_FILES = add_layers_dialog_base.ui
...
QGISDIR=C:\Users\Rodrigo Corvera\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
